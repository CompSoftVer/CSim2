...
lemma sep_map'_lift:
  "(p \<hookrightarrow>\<^sup>i\<^sub>g (v::'a::mem_type)) (lift_state (h,d)) \<Longrightarrow> CTypesDefs.lift h p = v"
...
lemma sep_map_lift:
  "((p::'a::mem_type ptr) \<mapsto>\<^sup>i\<^sub>g -) (lift_state (h,d)) \<Longrightarrow>
        (p \<mapsto>\<^sup>i\<^sub>g CTypesDefs.lift h p) (lift_state (h,d))"
...
lemma sep_map'_lift_rev:
  "\<lbrakk> CTypesDefs.lift h p = (v::'a::mem_type); (p \<hookrightarrow>\<^sup>i\<^sub>g -) (lift_state (h,d)) \<rbrakk> \<Longrightarrow>
