...
theory CTranslation
imports
  "CParserPart.PackedTypes"
  "CParserPart.PrettyProgs"
  "CParserPart.StaticFun"
  "CParserPart.IndirectCalls"
  "CParserPart.ModifiesProofs"
  "Lib.MLUtils"
  "HOL-Eisbach.Eisbach"
keywords
...
lemma guarded_spec_body_wp [vcg_hoare]:
  ...
  \<Longrightarrow> \<Gamma>,\<Theta>\<turnstile>\<^bsub>/F \<^esub> P (seq_guarded_spec_body Ft R) Q, A"
  apply (simp add: seq_guarded_spec_body_def)
  apply (cases "Ft \<in> F")
