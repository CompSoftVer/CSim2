...
<INITIAL,TDEF,TS,TSS,TSI>"lock"     =>
     (tok(Tokens.YLOCK,source,yypos,yypos+size yytext-1));
<INITIAL,TDEF,TS,TSS,TSI>"await"     =>
     (tok(Tokens.YAWAIT,source,yypos,yypos+size yytext-1));
<INITIAL,TDEF,TS,TSS,TSI>"id"     =>
     (tok(Tokens.YID,source,yypos,yypos+size yytext-1));
